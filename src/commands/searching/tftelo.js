...
const { getEntriesBySummoner } = require("@services/REST/riotAPI").default;
const { Info, Error, Warning } = require("@util/embedMessage");
...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (entries.length === 0) {
            ...
            return interaction.editReply(Warning(embed).withFile(await getRankPic("UNRANKED")));
        }
        ...
        for (const entry of entries) {
            ...
            }).withFile(await getRankPic(entry.tier));
